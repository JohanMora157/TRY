/*
ENTRADAS: nombre del voluntario, cédula del voluntario, ruta seleccionada, número de participantes,
número de guías, temperatura en grados centígrados, porcentaje de humedad relativa.

SALIDAS: mensaje de bienvenida al voluntario, información detallada sobre la ruta seleccionada (punto de encuentro, hora de inicio, hora de finalización),
mensaje indicando si es un buen día para caminar en Cali, cantidad total de personas que participarán en la actividad,
número de buses necesarios para transportar a todos los participantes.

EJEMPLOS:
Ejemplo 1:
Entradas:

Nombre: "Carlos", Cédula: 123456789, Ruta: "Farallones", Número de participantes: 30, Número de guías: 5, Temperatura: 22°C, Humedad: 50%

Salidas:
"¡Bienvenido, Carlos!"
"¡Excelente! La Ruta de los Farallones tiene como punto de encuentro Calle 16 - Universidad del Valle iniciando a las 6:40 am, y termina a las 4:00 pm."
"¡Hace un buen día para caminar por Cali!"
"Al ser un total de 35 personas que harán parte de la actividad, se necesitarán un total de: 2 buses para llevarla a cabo de manera exitosa. ¡Nos vemos en la COP16!"

Ejemplo 2:
Entradas:

Nombre: "María", Cédula: 987654321, Ruta: "Oriente", Número de participantes: 50, Número de guías: 10, Temperatura: 18°C, Humedad: 65%

Salidas:

"¡Bienvenido, María!"
"¡Excelente! La Ruta de el Oriente tiene como punto de encuentro Calle 16 - Universidad del Valle iniciando a las 6:40 am, y termina a las 4:00 pm."
"No es el mejor día para caminar por Cali."
"Al ser un total de 60 personas que harán parte de la actividad, se necesitarán un total de: 3 buses para llevarla a cabo de manera exitosa. ¡Nos vemos en la COP16!"
 */
