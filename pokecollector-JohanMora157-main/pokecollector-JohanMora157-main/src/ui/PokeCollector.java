    ...
    */
    ...
    public   void registrarCarta() {
        ...
        while (true) {
            ...
            if (controladora.analizarId(id)==true) {
...
if(controladora.memoria[0]!=null){
    ...
    String consulta = controladora.buscarCarta(idAConsultar);

        if (consulta == null){
        System.out.println("No existe una carta registrada con ese ID");
    
        }else{
        System.out.println("La carta es: "+consulta.getNombre()+ " - "+consulta.getPuntosVida()+" - "+consulta.getTipo()+" - "+consulta.getRareza());
        }
...
/**
     * Descripcion: Este metodo se encarga de bucar la carta segun el id dado por el usuario o devolver un null si no esta la carta
     * pre: el arreglo memoria debe de estar inicializado
     */

/**
     * Descripcion: Este metodo se encarga de recorrer todo el arreglo de memoria e ir imprimiendo todo lo que tenga contenido en el
     * pre: el arreglo memoria debe de estar inicializado
     */
...
if(controladora.memoria[0]!=null){
    ...
    String nameAModificar = reader.nextLine();
    String consultaName = controladora.buscarCarta(nameAModificar);
    ...
    switch (opcion) {
        case 1:
                ...
                System.out.println("Proporcione el nuevo nombre del pokemon en la carta ");
                  mob = reader.nextLine();
                    if (consultaName == null){
                         System.out.println("No existe una carta registrada con ese ID");
                        
                    }else{
                    System.out.println("La carta de ID "+consultaName.getID()+" se hacaba de  modificar");
                        consultaName.setNombre(nuevoName);
                    }
        ...
        case 2:
            ...
            int nuevoPv = reader.nextInt();
                if (consultaPv == null){
                     System.out.println("No existe una carta registrada con ese ID");
                    
                }else{
                System.out.println("La carta de nombre "+consultaPv.getNombre()+" se hacaba de  modificar");
                    consultaPv.setPuntosVida(nuevoPv);
                }
        ...
        case 3:
            ...
            String nuevoTipo = reader.nextLine();
                ...
                System.out.println("La carta de nombre "+consulta.getNombre()+" se hacaba de  modificar");
        ...
        case 4:
            ...
            String nuevoTipoRare = reader.nextLine();
                if (consultaRare == null){
                     System.out.println("No existe una carta registrada con ese ID");
                    
                }else{
                System.out.println("La carta de nombre "+consultaRare.getNombre()+" se hacaba de  modificar");
                    consultaRare.setRareza(nuevoTipoRare);
                }
...
/**
     * Descripcion: Este metodo se encarga bucar la carta segun el id dado por el usuario o devolver un null si no esta la carta
     * pre: el arreglo memoria debe de estar inicializado
     */
...
/**
     * Descripcion: Este metodo se encarga de ordenar de mayor a menor todo el arreglo de cartas
     * pre: el arreglo memoria debe de estar inicializado
     */
